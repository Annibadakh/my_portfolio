...
import photo from './Images/Aniket.jpeg';
      ...
      <section id="header">
        <div className="header container">
          <div className="nav-bar">
            <div className="brand">
              <h1><span>B</span>adakh <span>A</span>niket</h1>
            </div>
        ...
        <div className="contact container">
          ...
          <div className="contact-items">
            ...
            <div className="contact-item">
              ...
              <div className="contact-info">
                <h1>Email</h1>
                <h2>aniketbadakh1212@gmail.com</h2>
              </div>
            </div>
            <div className="contact-item">
        ...
        <div className="footer container">
          ...
          <div className="social-icon">
            <div className="social-item">
              <a href="https://www.linkedin.com/in/aniket-badakh-42b645277/"><img src={linke} alt="linkedin icon" /></a>
            </div>
            <div className="social-item">
              <a href="https://github.com/Annibadakh"><img src={git} alt="github icon" /></a>
            </div>
            <div className="social-item">
              <a href="https://www.instagram.com/aniket__17_00?igsh=MWV6aGUxNTJ0cTJ5ZA=="><img src={insta} alt="instagram icon" /></a>
            </div>
          </div>
          <p>Copyright © 2024 ANIKET. All rights reserved</p>
        </div>
      </section>
    </>
